...
//{
//    public class ModelBindingConvertTest
//    {
//        [Fact]
//        public void ConvertTo_ReturnsNullForReferenceTypes_WhenValueIsNull()
//        {
//            var convertedValue = ModelBindingConvert.Convert(null, typeof(string));
...
//        {
//            var convertedValue = ModelBindingConvert.Convert(null, typeof(int));
...
//            // Act
//            var converted = ModelBindingConvert.Convert(value, typeof(string));
...
//            // Act
//            var converted = ModelBindingConvert.Convert<string[]>(value);
